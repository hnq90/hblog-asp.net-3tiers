...
namespace Intelligencia.UrlRewriter.Configuration
{
    ...
    {
        private readonly ActionParserFactory _actionParserFactory;
        private readonly ConditionParserPipeline _conditionParserPipeline;
        private readonly IConfigurationManager _configurationManager;
        private readonly StringCollection _defaultDocuments;

        private readonly IDictionary<int, IRewriteErrorHandler> _errorHandlers =
            new Dictionary<int, IRewriteErrorHandler>();

        private readonly IList<IRewriteAction> _rules = new List<IRewriteAction>();
        private readonly TransformFactory _transformFactory;
        private readonly string _xPoweredBy;
        ...
        public RewriterConfiguration(IConfigurationManager configurationManager)
        {
            ...
            _xPoweredBy = MessageProvider.FormatString(Message.ProductName,
        ...
        private void LoadFromConfig()
        {
            ...
            if (section == null)
            {
                throw new ConfigurationErrorsException(
                    MessageProvider.FormatString(Message.MissingConfigFileSection, Constants.RewriterNode), section);
            }
